...
# Depends: python-dpkg. Install: pip install pydpkg
...
class DpkgInfo:
    ...
    def __str__(self):
        ...
        keyOrder=[
            ...
            'Pre-Depends','Depends','Conflicts','Breaks','Replaces','Recommended',
			'Author','Maintainer','Sponsor','dev',
			'Depiction','SileoDepiction','Homepage','Website','Support','Icon',
			'Section','Tag','Priority','Provides',
            'Size','Installed-Size','Filename',
            'MD5sum','SHA1','SHA256'
        ]
